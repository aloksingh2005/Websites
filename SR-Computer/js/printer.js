// Printer services page specific JavaScript functionality

document.addEventListener('DOMContentLoaded', function () {
    // Initialize animations
    initScrollAnimations();

    // Add any printer services page specific functionality here
    console.log('Printer services page loaded');
});
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    serviceCards.forEach(function (card) {
        ...
        card.addEventListener('mouseenter', function () {
            ...
            const image = this.querySelector('.printer-icon-img');
            if (image) {
