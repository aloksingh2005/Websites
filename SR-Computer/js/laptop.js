// Laptop services page specific JavaScript functionality

document.addEventListener('DOMContentLoaded', function () {
    // Initialize animations
    initScrollAnimations();

    // Add any laptop services page specific functionality here
    console.log('Laptop services page loaded');
});
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    serviceCards.forEach(function (card) {
        ...
        card.addEventListener('mouseenter', function () {
            ...
            const image = this.querySelector('.laptop-icon-img, .product-img');
            if (image) {
