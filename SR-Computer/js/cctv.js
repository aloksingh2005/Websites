// CCTV page specific JavaScript functionality

document.addEventListener('DOMContentLoaded', function () {
    // Initialize animations
    initScrollAnimations();

    // Add any CCTV page specific functionality here
    console.log('CCTV page loaded');
});
...
document.addEventListener('DOMContentLoaded', function () {
    const serviceCards = document.querySelectorAll('.service-card, .camera-type');
    ...
    serviceCards.forEach(function (card) {
        ...
        card.addEventListener('mouseenter', function () {
            ...
            const image = this.querySelector('.camera-icon-img, .camera-type-img');
            if (image) {
